...
const Modal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black/40">
      <div className="relative flex flex-col bg-white shadow-lg overflow-hidden max-w-lg w-full rounded-lg">
        {/* Modal Header */}
        {!hideHeader && (
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            ...
            {showActionBtn && (
              <button className="btn-small-light mr-4" onClick={onActionClick}>
                {actionBtnIcon}
                {actionBtnText}
              </button>
            )}
